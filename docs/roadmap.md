...
The plan is staged so each step is playable on its own. Stages 1 through 6 and 8 are shipped;
stage 7 — the Hospitality bridge — is designed, not built, and is the only staged item left.
...
shop that's genuinely overpriced. The faro table shipped purely decorative in this stage; stage 8
below is what promotes it into a real business.
...
**8. Gambling hall — done.** The first business where the "sale" is a wager rather than a
